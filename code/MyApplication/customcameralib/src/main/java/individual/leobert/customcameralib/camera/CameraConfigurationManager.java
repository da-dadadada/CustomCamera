...
//	private Point displayAreaResolution;
	...
	void initFromCameraParameters(Camera camera,Point displayAreaResolution) {
		...
		Point previewResolutionForCamera = new Point();
		previewResolutionForCamera.x = displayAreaResolution.x;
		previewResolutionForCamera.y = displayAreaResolution.y;

		if (displayAreaResolution.x < displayAreaResolution.y) {
			previewResolutionForCamera.x = displayAreaResolution.y;
			previewResolutionForCamera.y = displayAreaResolution.x;
		}
		cameraResolution = getCameraResolution(parameters, previewResolutionForCamera);
	}
	...
	void initFromCameraParameters(Camera camera) {
		...
		Point screen = new Point(display.getWidth(), display.getHeight());

		initFromCameraParameters(camera,screen);
	}
